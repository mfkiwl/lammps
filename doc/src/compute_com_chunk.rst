...
This compute calculates the :math:`(x,y,z)` coordinates of the center of
...
.. note::
   ...
   The coordinates of an atom contribute to the chunk's center-of-mass
   ...
   :doc:`reset_atoms image <reset_atoms>` or :doc:`set image <set>`
   commands.
...
for the :math:`(x,y,z)` center-of-mass coordinates of each chunk.  These
