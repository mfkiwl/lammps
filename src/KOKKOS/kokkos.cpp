...
KokkosLMP::KokkosLMP(LAMMPS *lmp, int narg, char **arg) : Pointers(lmp)
{
  ...
  if (ngpus > 0) {
    ...
    forward_pair_comm_legacy = reverse_pair_comm_legacy = forward_fix_comm_legacy = reverse_fix_comm_legacy = 0;
    sort_legacy = 0;
    atom_map_legacy = 0;
    ...
    forward_pair_comm_legacy = reverse_pair_comm_legacy = forward_fix_comm_legacy = reverse_fix_comm_legacy = 1;
    sort_legacy = 1;
    atom_map_legacy = 1;
