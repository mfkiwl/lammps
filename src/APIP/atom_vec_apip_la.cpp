...
AtomVecApipLa::AtomVecApipLa(LAMMPS *lmp) : AtomVec(lmp)
{
...
void AtomVecApipLa::grow_pointers()
{
...
void AtomVecApipLa::data_atom_post(int ilocal)
{
...
void AtomVecApipLa::force_clear(int n, size_t nbytes)
{
